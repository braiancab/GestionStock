...
from services.pdf_presupuesto import PDFPresupuestoService
...
class VentanaPresupuesto:
    ...
    def __init__(
        ...
        self.pdf_service = PDFPresupuestoService()

        self.id_presupuesto = None
    ...
    def crear_interfaz(self):
        ...
        frame_inferior.grid_columnconfigure(
            0,
            weight=1
        )
    ...
    def eliminar_producto(self):
        ...
        if not seleccion:
            ...
            messagebox.showwarning(
                ...
                "Seleccione un producto del presupuesto.",
        ...
        del self.productos_presupuesto[
            indice
        ]
    ...
    def guardar_presupuesto(self):
        ...
        confirmar = messagebox.askyesno(
            ...
            "¿Desea guardar este presupuesto?",
        ...
        try:
            ...
            messagebox.showinfo(
                ...
                f"El presupuesto se guardó correctamente.\n\n"

                f"Presupuesto N°: {id_presupuesto}\n"
